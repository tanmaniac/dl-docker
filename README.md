...
**CPU Version**
```bash
docker build -t tanmaniac/dl-docker:cpu -f Dockerfile.cpu .
```

**GPU Version**
```bash
docker build -t tanmaniac/dl-docker:gpu -f Dockerfile.gpu .
```
...
**CPU Version**
```bash
docker run -it -p 8888:8888 -p 6006:6006 -v /sharedfolder:/root/sharedfolder tanmaniac/dl-docker:cpu bash
```
	
**GPU Version**
```bash
nvidia-docker run -it -p 8888:8888 -p 6006:6006 -v /sharedfolder:/root/sharedfolder tanmaniac/dl-docker:gpu bash
```
